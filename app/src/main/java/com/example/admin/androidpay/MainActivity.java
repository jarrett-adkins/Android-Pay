...
public class MainActivity extends AppCompatActivity implements
    ...
    public static final int MASKED_WALLET_REQUEST_CODE = 9001;
    public static final int FULL_WALLET_REQUEST_CODE = 9002;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check if WalletFragment exists so we don't add it twice.
    ...
    private MaskedWalletRequest generateMaskedWalletRequest() {
        // we're defining that we want the user's phone number, shipping address and that they're
        // purchasing a Google I/O sticker for approximately $15 (including tax and shipping)
...
//https://codelabs.developers.google.com/codelabs/android-pay/#0